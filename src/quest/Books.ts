 ...
 *
 * They contradict each other, and that is the design. The Shirenamat creation
 * myth and the Temple's corrected account cannot both be true; the Valmori
 * history of the ash-frontier and the Shirenamat account of the same fifty years
...
They ask us why we keep no city. We ask them what a city is for, if the ash was first and the ash is patient. They have never answered. They have built another wall instead, and invoiced us for the lamp oil.`,
  ...
  making_corrected: {
    ...
    skill: 'restoration',
    text: `It is necessary to state plainly, and at the outset, that the world was made and did not simply occur. The ash is not first. The ash is a residue, and a residue implies a burning, and a burning implies a fire, and a fire implies a hand that struck it. The Shirenamat recitation, which begins by asserting an eternal ash, is therefore not a rival account of creation but a refusal of the question.

The Three came into their divinity by the Rite at Ember Mount, and the province was ordered by them: the roads, the calendar, the law of ancestors, the shape of the year. That there is now silence from the Three is not evidence of their absence but of their attention being elsewhere, and a faith which requires constant reassurance is a market stall, not a faith.
...
To the curate who taught me, if he reads this: I am not your enemy. I am the consequence of your teaching me to check the sources.`,
  ...
  hlaalu_prospects: {
    id: 'hlaalu_prospects',
    title: 'Varo Prospects: An Address to New Kinsmen',
    author: 'the Council of House Varo',
    kind: 'propaganda',
...
Korran will tell you a House is for honour. Ask a Korran retainer what he ate this week. Vaelmyr will tell you a House is for power, by which they mean one wizard's power and your obedience to it. Varo says a House is for prosperity, and prosperity is measurable, and what is measurable can be argued about honestly.

Three principles.

The first: never break a law you could instead amend. Amendment is slower and it lasts.

The second: the Concord is not our master and not our friend. It is our largest customer. Treat it as you would treat any large customer — punctually, courteously, and with a signed schedule.
...
You will hear it said in Ald Sethis that Varo takes a widow's house. Varo takes what a signed note says Varo takes. If you find that ugly, the remedy is in the drafting of notes, and the drafting of notes is a career, and it is yours.`,
  },

  watch_does_not_sleep: {
    id: 'watch_does_not_sleep',
    title: 'The Watch Does Not Sleep',
    author: "Archmaster's office, House Korran",
    kind: 'propaganda',
    teaches: ['house_redoran', 'great_houses', 'ash_storms'],
    skill: 'block',
    text: `A House is judged by what it holds when holding costs it.

Varo holds the harbour, which pays. Vaelmyr holds its towers, which nobody wants. Korran holds the ash-frontier, which is a line on no map, cannot be sold, produces nothing, and must be walked every night in every season by people who are not thanked for it.

That is the argument. There is not a second argument and Korran has never needed one.
...
On the matter of duels: they are lawful, they are witnessed, and they are to first blood unless both parties and the hall agree otherwise. A killing in an alley is not a duel. A hireling is not a duel. If you cannot tell the difference you are not Korran, whatever the roll says.`,
  },
  ...
  sovereignty_of_wizards: {
    ...
    skill: 'alteration',
    text: `The Ashen Conclave issues licences. Consider what that sentence contains.
...
I have not spoken aloud in eleven years. My Mouth speaks for me and speaks accurately. If you find that sinister, consider how much of what you were told today was said by the person who decided it.`,
  ...
  impartial_history: {
    ...
    author: 'Praefect Gaius Voleni, Valmori Provincial Office',
    kind: 'history',
...
The frontier is now quiet. Trade moves. The strider runs on a published schedule. Whatever may be said of the method — and a great deal is said, in the Flagon, after the fourth drink — the result is a road where there was no road.`,
  ...
  what_the_ashlanders_say: {
    ...
    title: 'What the Shirenamat Say About the Ash-Frontier',
    author: 'set down by Zabamat, Wise Woman of the Shirenamat',
    kind: 'history',
    teaches: ['ashlanders', 'ald_sethis'],
    text: `The outlander history says we were unadministered. We were administered. We administered ourselves, and the arrangement had run for longer than his Concord had existed, and he did not ask about it because he had already decided that administration is a thing done with ink.

He says the Concord surveyed. Yes. A survey is a man with a chain walking across your grazing, and then a paper that says the grazing belongs to whoever paid the man with the chain.
...
He says the port pre-dates the Concord "in the local telling". The local telling is us. Our dead are under his customs house. We told him where they were, so he would build around them, and he built on them and wrote that no documentary support could be found.
...
The frontier is quiet. That is true and I will not pretend otherwise. It is the quiet of a room after an argument that one party won.`,
  ...
  netch_song: {
    id: 'netch_song',
    title: 'The Skerrin-Song of Llevo, Canto the Fourth',
    author: 'Llevo the Versifier, unassisted',
    kind: 'poetry',
    teaches: ['bad_poetry'],
    text: `O skerrin! O bulbous wanderer of air!
...
The drell has legs. The morvek has a queen.
The ash shrike is horrible and mean.
But thou, O skerrin, hast neither leg nor guile —
...
To dun thee at thy door. O happy skerrin!

(Here the poet intends a stanza on the subject of the skerrin's diet, which is not
yet written, the poet having been unable to establish what a skerrin eats, and the
Flagon having declined to fund a research expedition.)

O skerrin! O skerrin! O — something — skerrin! O skerrin!
...
The twelfth awaits. The word, I think, is "fetch".`,
  ...
  provender: {
    ...
    skill: 'alchemy',
    text: `SCUTTLE, PROPERLY MADE. Take the ripe cuttle of the morvek, a full hand of it, and work it with the back of a spoon until it gives. Add ash-salt, one pinch, and not two, whatever the miners tell you. Set it in a cold press under a stone for three days. It should smell like a cellar and not like a mistake. Serve on hard bread with a slice of raw saltrice. Anyone who serves it warm is either an outlander or in a hurry.

ASH-YAM, ROASTED WHOLE. Bury them in the embers, do not peel them, and do not touch them for an hour by the glass. The skin goes to charcoal and holds the whole thing together. Break it at the table. A Korran will eat four of these and call it a light supper.

MARSHMERROW STEW WITH GUAR. Drell shoulder, cut across the grain, browned hard in its own fat. Marshmerrow, comberry, one small hackle-lo leaf, and water to cover. Three hours, and add nothing else — the fashion for putting vekling jelly in it comes from Suneth and should stay there.

ON THE BOILING OF KWAMA EGG. Do not. A morvek egg is not a chicken's egg and a boiled one is a hard grey sorrow. Bake it in its shell in a low oven with a thumb of butter dropped through the top.

ON HOSPITALITY. The Shirenamat will not eat at your table and it is not an insult; they will not eat at anyone's table. Send the food out. It comes back as an empty dish, and that is the whole of the courtesy, and it is enough.`,
  },

  locks_and_law: {
    id: 'locks_and_law',
    title: 'A Practical Treatise on Locks, Wards, and the Law Concerning Both',
    author: 'attributed to "a retired gentleman of Kethrin"',
    kind: 'manual',
...
On tumblers. The Ashenreach warded lock has between three and seven pins and the pins are of unequal length by design, so that the novice, having felt two set, believes himself nearly finished. He is not nearly finished. He is at the point in the work where the maker expects him to become confident.

On the law. Under Valmori statute as applied in the province, the offence is complete at the moment of entry and is not conditional on taking anything. This surprises people, and the surprise is usually expressed in a cell. Note further that a witness is required for a bounty to be assessed, that the witness need not be the owner, and that in law a guard who sees you leave a building is a witness to your having been in it.
...
On the guards of Ald Sethis specifically: they walk where the lamps are. This is not laziness. It is the rota. Learn the rota.`,
  ...
  fourth_gallery_letter: {
    ...
    author: 'Falia Beren, apprentice of the Ashen Conclave',
    kind: 'letter',
...
Your Falia`,
  ...
  sixteen_beasts: {
    ...
    kind: 'manual',
    teaches: ['fenwalker', 'ash_storms', 'blight'],
    skill: 'marksman',
...
THE SILT STRIDER. Not a beast, a colleague. She will walk a road she knows in weather that would put a drell down, and she will refuse a road she does not know in perfect sunshine. Do not argue. She is right more often than the schedule.
...
THE CLIFF RACER. There is nothing to be said about the ash shrike that has not been said louder by someone with a spear.
...
THE NETCH. Bull skerrin will defend a radius and the radius is bigger than you think. Betty skerrin will not. Learn the difference from a distance; learning it from close is how carters get famous.
...
[Zabamat's hand, on the hide:] The fourth verse is in a different ink and a steadier hand than the other three. I have said so for forty years to anyone who would sit still. Nobody has ever wanted to hear that the ending was written later.`,
  ...
  ledger_practice: {
    ...
    author: 'Varo Hleran, House Varo, for internal circulation',
    kind: 'manual',
