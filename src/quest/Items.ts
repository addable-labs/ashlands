...
export const ITEMS = {
  ...
  hlaalu_ledger: { id: 'hlaalu_ledger', name: 'the second Varo ledger', value: 400, quest: true },
  muran_spore: { id: 'muran_spore', name: 'gallery spore of Tel Muran', value: 250, quest: true },
  guild_shipment: { id: 'guild_shipment', name: 'Ironring strongbox', value: 300, quest: true },
  kwama_reagents: { id: 'kwama_reagents', name: 'morvek cuttle and vekling jelly', value: 40, quest: false },
  writ_of_execution: { id: 'writ_of_execution', name: 'Varo writ of execution', value: 0, quest: true },
